...
SOURCES = bellTower.cpp character.cpp combat.cpp darkPriest.cpp fighter.cpp game.cpp inventory.cpp main.cpp room.cpp sanctuary.cpp specialAction.cpp tile.cpp treasure.cpp utility.cpp

# object files (use as shortcut)
OBJECTS = bellTower.o character.o combat.o darkPriest.o fighter.o game.o inventory.o main.o room.o sanctuary.o specialAction.o tile.o treasure.o utility.o
