...
SOURCES = main.cpp character.cpp fighter.cpp game.cpp inventory.cpp room.cpp sanctuary.cpp tile.cpp treasure.cpp utility.cpp

# object files (use as shortcut)
OBJECTS = main.o character.o fighter.o game.o inventory.o room.o sanctuary.o tile.o treasure.o utility.o
