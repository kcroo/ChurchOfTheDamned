	...
	: Character(10, "Dark Priest", "", 'P', 4)		// HP, type, name, symbol, MP, level
{
	...
	specialActions.push_back(std::make_unique<SpecialAction>(ActionType::MP, "Unholy Meditations", "Communing with the priest's hellish overlords restores 4 MP.", 1, 0, 0, 0, 0, 4));
}
